...
| Path | What it is |
| --- | --- |
| [`packages/us-federal-tax`](packages/us-federal-tax) | A zero-dependency US federal tax engine for JavaScript. Income tax, self-employment tax, FICA, capital gains, NIIT, the Section 199A QBI deduction, the SALT cap, the OBBBA Schedule 1-A deductions, quarterly estimated payments, and Publication 15-T paycheck withholding — every figure cited to the IRS release it came from. **v0.12.0 is a correction in the opposite direction from the last three: those made a widow's bill too LOW, this makes a separate filer's too HIGH — the error nobody complains about.** A married individual filing a SEPARATE return was denied the OBBBA car loan interest deduction outright, worth up to `$10,000` and `$2,200` of tax on `$90,000` of wages, because one `ineligibleFilingStatuses` list answered for all four Schedule 1-A deductions at once. Its docstring named § 224(f) and § 225(e) by subsection and then said the senior deduction and the vehicle loan interest deduction "carry the same restriction per IRS guidance" — two provisions read, two waved at, and § 163(h)(4) has no married-individuals clause at all. **A shared citation is the shape of the defect**: it launders a claim nobody checked through one somebody did, and a test now fails if any two of the four citations are equal. Two more in § 63, both now inputs because a return does not contain the fact: § 63(c)(6)(A) zeroes the standard deduction where the other spouse itemizes, and § 63(f)(1)(B) via § 151(b) ALLOWS the spouse's age and blindness amounts on a separate return — the one sentence in the Code that reaches a separate return and not a joint one. `EstimateResult.notes` is new and says what the engine discarded. v0.11.0 finished what v0.10.0 started, and the finish was much larger than the start: The Code splits its thresholds on the words "in the case of a joint return", and where it means to include a widow or widower it names one: § 1411(b) does, § 63(c)(2)(A) does, § 1(j)(5)(B) does. § 24, § 32 and § 199A do not — and a QUALIFYING SURVIVING SPOUSE does not file a joint return, because § 2(a) hands them the joint RATE SCHEDULE and nothing else. v0.10.0 fixed § 32 (the earned income credit phase-out, `$1,161.75` on one child at `$45,000`, which moved the STATE answer in six more states because six of them take a flat percentage of the federal credit). v0.11.0 fixes the other two: the **child tax credit threshold** (`$400,000`, and it is `$200,000` — a widow with two children at `$300,000` of wages was given the full `$4,400` and gets nothing) and **both § 199A figures** (`$403,500` and `$150,000` for 2026; they are `$201,750` and `$75,000`). **A widowed consultant with `$300,000` of profit and one child was told she owed `$63,242.40` for 2026. She owes `$75,893.38`** — `$12,650.98` on one return, the largest single-household error this package has shipped, and like the other two it ran in the direction that makes the widow's bill too low. The § 24 figure had a comment on it calling the question UNRESOLVED because irs.gov is blocked from this sandbox; the statutory sentence settles it unaided and was quoted in that comment, and the only thing on the other side was that a second model carries `$400,000` too. **What is new besides the numbers is that the question is closed**: [`test/surviving-spouse.test.js`](packages/us-federal-tax/test/surviving-spouse.test.js) walks the parameter tree, finds all twenty status-keyed tables in three tax years, and makes each declare its grouping and quote the phrase that decides it — so a new one cannot be added without answering the question, and an entry whose two candidate figures stop differing fails as VACUOUS rather than passing for ever. |
| [`packages/us-state-tax`](packages/us-state-tax) | A zero-dependency US **state and local** income tax engine for 28 states and **1,033 local income taxes** — New York City, Yonkers, all 24 Maryland jurisdictions, all 92 Indiana counties, all 24 Michigan cities, all 679 Ohio municipalities and all 214 Ohio school districts — 2025 and 2026. Built around the part a table of state rates cannot hold: **Ohio**, whose printed schedule is not a function — 0% on the first $26,050 and then a flat constant *plus* 2.75%, charged whole on the first dollar of the band, so a filer at $26,050 owes $0 and one at $26,050.01 owes $342.00, and a marginal walk of the printed rows understates every Ohio filer by the whole constant — which steps a second time by $18.69 at $100,000 because HB 96 re-based one constant and left the other at what the old one chained to; where the first $250,000 of business income is deducted and the excess taxed at a flat 3%, so $250,000 of Schedule C profit costs $0 where $250,000 of wages costs $7,022.45; where two published credits turn out to be unclaimable once the zero band is set against their income ceilings; and whose 679 municipalities charge 0.45%–3.00% on *qualifying wages*, box 5 of the W-2, so a 401(k) deferral does not reduce the base ($612.50 a year for a Columbus saver) while a retiree owes nothing at all — making the municipal tax the larger half of every Ohio return below $126,408.32 of income — and whose 214 school districts levy a THIRD tax on the same paycheck, 68 of them on box 1, so a 401(k) deferral is inside one local wage tax and outside the other; **Michigan**, whose 24 cities tax a base the MI-1040 does not contain, excluding pensions, IRA distributions, Social Security, unemployment and military pay entirely, where Detroit charges residents 2.4% against a state rate of 4.25%, where the personal exemption has been the $600 fixed in 1964 and is worth $14.40 of tax against an indexed $5,900 state exemption, and where a resident working in another taxing city is credited only up to their own city's nonresident rate — so a Lansing resident commuting to Detroit pays 70% more city tax than one working at home; **Indiana**, where the average county rate is 1.914% against a state rate of 3.00%, so two fifths of the bill is levied by a county — Randolph County at the 3.00% statutory maximum charges more than the state does from 2026, Porter County charges one sixth of that, and six counties raised their rate for 2026 in the year the state cut its own; **Maryland**, where every resident owes a county income tax of 2.25%–3.30% on the same taxable income — a third to two fifths of the whole bill, reported by no table of state rates — where Frederick County's bracket selects one rate that applies to the *whole* income so one dollar at $150,000 costs $360.03 while the same dollar in Anne Arundel costs three cents, where the county earned income credit is not stored but is ten times each county's own rate, and where the new 2% capital gains surtax is a test rather than a floor, so one dollar of AGI at $350,000 can cost $6,933.08; **Georgia**, whose retirement income exclusion is the mirror image of Maryland's and is described that way nowhere: both exempt "retirement income" at 65 and publish a number for it, and then Georgia counts taxable IRA distributions in full and charges nothing against the exclusion while Maryland writes an IRA out of it by name and charges the whole Social Security benefit against it — so the rollover every adviser recommends costs $0.00 in Georgia and $3,378.83 a year in Maryland, and moving a third of a retirement into Social Security saves $1,272.45 in one and costs $357.75 in the other; where at most $5,000 of a person's wages may enter the exclusion, making it a test on the type of a retiree's income rather than its amount — at 65 a filer with $65,000 of dividends owes nothing and one with $65,000 of wages owes $2,245.50; where net capital gain is in the pool and the allowance is annual and per person, so the "retirement income exclusion" is also a capital gains allowance that lets a couple both 65 realise $130,000 of gain a year tax-free; and where composing the ordinary exclusion with the military one gives a true maximum of $70,000 rather than the $65,000 every table prints, for a disabled veteran under 62 whose exclusion then falls by half on their sixty-second birthday — the birthday every guide calls the one where Georgia's exclusion begins; **Kentucky**, whose published $31,110 pension exclusion is not its maximum and is not its shape: retired pay from the federal government, the Commonwealth or a Kentucky local government is exempt *in full* to the extent it is attributable to service performed before 1 January 1998, with no ceiling — and that exemption does not consume the $31,110, which stays available against everything else, so a teacher who served 1975–2005 with a $70,000 pension and a $40,000 IRA excludes $84,776.67; where the exclusion has **no age test at all**, making Kentucky the only one of the three retirement states an early retiree can use — at 55 a couple with $70,000 of pension pays $157.85 in Kentucky, $1,996.00 in Georgia and $4,471.05 in Montgomery County, and at 65 the ranking reverses and Kentucky is the only one of the three that charges anything; and where the 1998 cutoff has never moved, so every further month of service dilutes the exempt percentage and two teachers with identical pensions pay $1,878.33 apart on the decade they happened to work; **Massachusetts**, which every rate table reports as a flat 5% and which taxes short-term capital gains at 8.5% and long-term gains on collectibles at 12% on half the gain; New York's supplemental tax, which claws back the benefit of the lower brackets so a high earner pays their top rate on their whole income; New York City's resident tax, which costs more than the entire state tax of thirteen of those states; New Jersey, which has no federal starting line at all and whose retirement exclusion ends in a wall that costs a joint retiree $1,381 on one dollar of income; which federal figure each state starts from; which federal deductions it adds back; California's CalEITC, which has no plateau at all, so a single parent faces minus 34% and plus 34% on consecutive dollars of income; **Utah**, whose 4.45% flat tax reaches a real marginal rate of **15.26%** on a retiree — 3.4 times the statutory rate, and three rules compounding with no bracket among them: § 86 puts $1.85 of taxable income behind each dollar of pension, Utah taxes all of it, withdraws 2.5 cents of Social Security Benefits Credit per dollar of it and 1.3 cents of Taxpayer Tax Credit per dollar of it — and the rate runs 10.64% → 15.26% → 8.25% as income rises, so the highest-taxed next dollar in Utah belongs to a household in the 12% federal bracket; where the state taxes the benefit and hands the whole tax back as a credit below $90,000 of modified AGI, making Social Security free and then charging 2.5% for every dollar of *anything else*; where tax-exempt interest is added back for that test, so a municipal bond is taxed at 2.5% while appearing on no line of Utah income; where the three retirement credits are an **election** — code 18 or codes AH and AJ, never both — and code 18 is all but dead law, worth at most $395.00 in a $22,600 window of income, to filers born on or before 31 December 1952, and only where there is no Social Security at all; and where the military retirement credit is *defined* as the rate by cross-reference rather than stored as a number, which is why it moved when the rate did and PolicyEngine-US's stored copy did not; where the child tax credit is withdrawn at TEN cents on the dollar — 2.2 times the state's own rate, so the withdrawal is a larger marginal tax than the tax is — taking a working couple with two children to **20.00% on the next dollar**, higher than the retiree's 15.26%, and where a family with MORE eligible children can face a LOWER rate because the band's length scales with the credit and its end moves out of the earned income credit's own withdrawal; and the credit phase-outs that make Utah's and Pennsylvania's flat taxes anything but flat. **And ten states that exempt Social Security by statute were taxing it until v0.18.0** — Arizona, California, Idaho, Illinois, Indiana, Michigan, Mississippi, North Carolina, New York and Ohio — worth up to $1,517 a year to one retiree and enough to move fifteen of the nineteen taxing states in a ranking. Found by a differential test against an independent model, not by a test of a claimed feature: no feature had been claimed. **And four states that exempt most or all RETIREMENT income were taxing it until v0.19.0** — Illinois, Mississippi, Michigan and New York — because the package documented that the caller must net it out through `subtractions`, accepted a per-person `retirement` split that contained everything needed to compute it, and taxed the pension anyway: a retired couple with a $60,000 pension and $40,000 of Social Security was charged $2,588.85 in Illinois, $2,057.00 in Michigan and $1,336.00 in Mississippi, all three of which charge nothing at all. Illinois has **no age test at any point**, so a 40-year-old drawing a $200,000 pension owes Illinois nothing and is the only early retiree in this package who owes nothing anywhere; New York's $20,000 is per person and unused room is lost, so the same $40,000 of pension is excluded in full split and half taxed concentrated — $1,080 decided by whose name is on the plan — while a federal, New York State or New York local government pension is exempt in full at any age, so a retired New York City teacher on $90,000 pays nothing where a private-sector retiree on the same $90,000 pays on $70,000 of it; and Michigan's cap is ONE figure for the RETURN keyed to the OLDER spouse, at 75% of itself for 2025 because Public Act 4 of 2023 is restoring it a quarter at a time. North Carolina was on that list and does not belong there: it taxes a pension in full at 3.99% and lets go only Social Security, the Bailey cohort and military retired pay. **And v0.20.0 closes the one place this package was too LOW**, which is a direction of error it had never had: Illinois adds back interest on OTHER states' municipal obligations (35 ILCS 5/203(a)(2)(A)) while exempting its own, so an Illinois bondholder owes tax on income the federal return never saw and an engine that starts at federal AGI and stops misses all of it — pass `outOfStateMunicipalInterest`, which is deliberately not `taxExemptInterest` because that total would tax an Illinois resident on Illinois bonds and the split exists on no federal form. It only became visible when the retirement subtraction took a retiree's base to zero and nothing else was left to be wrong about. Also v0.19.0: the Illinois child tax credit (35 ILCS 5/244), 40% of a credit that is itself 20% of the federal § 32 credit, so it inherits the whole of that taper and takes a working Illinois parent of two to **10.85%** on the next dollar in the state whose entire tax policy is one rate for everybody. **And v0.21.0 is two corrections at the bottom of the income distribution, where the whole bill is at stake rather than a slice of it.** **Indiana** publishes a `$1,000` exemption a person and that is the smallest of the four on its Schedule 3: `$1,500` more for each dependent CHILD (under 19, or under 24 and a full-time student), `$1,000` for each filer at 65, `$1,000` for each blind filer, and `$500` MORE for each filer at 65 whose federal AGI is under `$40,000` — none of which was computed here, and the note that admitted it put the cost at "about `$44` per qualifying child", which was the STATE rate on `$1,500` in a state where two fifths of the bill is levied by a county. The real figure in Marion County is **`$74.55` a child**, `$149.10` for a family with two and `$149.10` for a retired couple under `$40,000`. The `$500` is the only means-tested exemption in the package and it is a cliff: one dollar of income at `$40,000` costs a joint retired couple **`$49.75`**. And the child exemption needs `dependentAges` rather than `dependents`, because an Indiana dependent child is worth `$2,500` of exemption and a dependent parent `$1,000` and a count cannot tell them apart. **Maryland's poverty level credit** (§ 10-709) is the only thing in a Maryland return that can forgive the WHOLE bill, and it is claimed twice at two different rates: 5% of earned income against the state tax and **the county's own rate** against the county tax — 2.25% in Worcester, 3.30% in Dorchester — so it is worth a different amount in each of the twenty-four jurisdictions and no per-county figure is stored anywhere, exactly like the local earned income credit. A single Maryland worker at `$15,000` went from `$160.85` to **nothing**. Both halves are capped at the tax they are claimed against, so neither can be paid out.  Pass `earnedIncome`. **And v0.22.0 adds two credits that turn on a fact no income figure carries.** **Georgia's eligible itemizer tax credit** (O.C.G.A. § 48-7-27.1) is `$300` for each taxpayer, `$600` on a joint return, and its only test is which box was ticked on the FEDERAL return — no income test at any level, so it is worth the same at `$50,000` and at `$5,000,000`. It inverts the rule every guide states about when to itemize: § 48-7-27(a)(1) ties the Georgia election to the federal one in BOTH directions, HB 1437 raised the Georgia standard deduction to `$15,000`/`$30,000` while leaving the itemized figure alone, and at 4.99% the credit is worth **`$6,012` of deduction** — so a Georgia itemizer whose itemized deductions fall that far SHORT of the standard deduction still comes out ahead, and a joint couple `$12,024` short. `stateItemizedDeductions` is now read for Georgia too, where it had been accepted and silently ignored. **Indiana's unified tax credit for the elderly** (IC 6-3-3-9) is refundable and is the ENTIRE return for a household living on Social Security: the state exempts the benefit, the `$5,000` of exemptions takes Indiana AGI below zero, the tax is nothing, and the `$140` is the only figure that moves. `$100`/`$50`/`$40` for one filer at 65 and `$140`/`$90`/`$80` for two, banded on FEDERAL AGI under `$1,000`, `$3,000` and `$10,000` — so none of Indiana's own generosity buys a dollar of room under the ceiling — and every one of the three edges is a cliff: one dollar at `$1,000` costs `$50`. One correction that is not a number: this package cited the Georgia credit as § 48-7-29.23 until v0.22.0, copied from PolicyEngine-US's own variable file. No such section exists, and their PARAMETER file has it right. **And v0.23.0 adds the two conditions a rate table cannot hold: being 65, and being blind.** Six states here already added an exemption for blindness; four more provisions existed with no rule and all four are now computed. **California** claims one more exemption CREDIT at 65 (Form 540 line 9) and one more for blindness (line 8), `$153` each and claimed PER PERSON, so a retired California couple was charged `$306` too much every year — and because they are credits rather than deductions they are worth the same `$306` at `$30,000` and at `$250,000`, which is exactly why California states its exemptions that way. § 17054(c) and (d) stack on one person, so a blind Californian of 65 claims three personal exemptions. **Michigan's** special exemption (MCL 206.30(3)(a)) is `$3,400`, the largest allowance for blindness in the package at `$144.50` of tax, and it covers deafness and total disability under 66 as well. **Mississippi** adds `$1,500` at 65 and `$1,500` for blindness (§ 27-7-21(f) and (g)) on the SAME line as the dependents, so a summary reporting "$1,500 per dependent" has described three of the four boxes. Also in California: the AGI limitation on the exemption credits is applied to each LINE of Form 540 and floored at zero THERE, not netted across the return — above about `$315,000` a single filer's `$153` personal credit is already gone and the `$475` dependent credit is not, and one subtraction across both would let the dead credit eat the live one. And a live defect these found in the MCP server: `blindOrDisabled` was refused for every state outside a hand-written `['NJ', 'IL', 'IN']`, so a **Maryland** caller was refused a field Maryland's own note tells them to pass, and Massachusetts and Virginia the same. That list is derived from the engine now. **The reason none of this was found for twenty-five days is the grid**: it had no blind filer in it at all, and its only 65-year-olds were retirees in states that exempt retirement income, where the tax is zero either way and an exemption cannot show. **And the same widening found the fifth filing status, which nothing in this project had ever filed.** A qualifying surviving spouse files an INDIVIDUAL return and is handed the joint rate schedule by § 2(a), which makes "follow the joint column" a good default and a bad rule. A per-person exemption is a count of people and there is one: Illinois, Indiana and Michigan were each giving a widow an exemption for a spouse who is dead — `$141.08`, `$49.70` and `$246.50` a year. And **Virginia has no surviving-spouse status at all**: Form 760 sends a federal head of household or qualifying surviving spouse to Filing Status 1, SINGLE, so a Virginia widow takes the `$8,750` standard deduction and one `$930` exemption rather than the joint figures — `$556.60` a year, on a status where Virginia's own age deduction and filing thresholds in this package already said single and the standard deduction did not. **And v0.24.0 closes the second half of the surviving-spouse question, which v0.23.0 left open because it is counted by a different helper.** `filerCount()` calls that status two filers and for an AMOUNT it is usually right — California's Form 540 line 7 says "If you checked box 2 or 5, enter 2" and box 5 IS the qualifying surviving spouse, so a Californian widow really does claim two personal exemption credits. For a COUNT OF PEOPLE it is never right: a caller passing `blindOrDisabled: 2` for a widow, which is exactly what a caller who believes the status implies two filers would pass, was allowed two blind allowances against a household of one — `$153` in California, `$144.50` in Michigan, `$60` in Mississippi, and the same doubling in Illinois, Indiana and New Jersey — while a single filer was correctly capped at one the whole time. A `spouseAge` on the same return bought a second SENIOR allowance the same way. Every condition is now capped by `livingFilerCount()`, and the two helpers are kept deliberately apart rather than reconciled, because reconciling them would mean overruling the FTB's own instruction. **When one fact is counted by two helpers the bug is not that they disagree; it is that nothing says which question each one answers.** **And v0.26.0 pays off the oldest debt in the package and finds that half of it was never a debt.** The `provisional` flag has existed since Day 8 to say out loud that a figure is carried forward while every competitor carries it forward silently; eight 2026 state-years still carried it, and the standing plan was that the backlog was one more afternoon. Three of them were: **Kentucky's** 2026 standard deduction is `$3,360` against the `$3,270` carried here — announced by the Department of Revenue and printed in the Commonwealth's own 2026 withholding formula, and worth `$3.15` to every Kentucky filer; **Michigan's** personal exemption is `$5,900` against `$5,800`, published in Michigan's 2026 withholding guide, `$4.25` per exemption on every Michigan return; and **Maryland's** `$3,350` is confirmed *unchanged* by the Comptroller's 2026 withholding guide, the 2026 Form MW507 and the fiscal note on a 2026 bill to raise it that died in committee — a figure that was already right and had been flagged for nine months because two secondary sources disagreed about it. All three had been sitting in a state document the whole time. **The other half is not a backlog at all, and that is the finding.** Four are waiting on a document that does not exist until January 2027, and **Colorado can never be resolved during the tax year in principle**: its 4.40% rate is set by a TABOR surplus calculation that runs *after* the year closes, so the figure here is a statutory UPPER BOUND and the 25% earned income credit match a FLOOR — the most tax and the least credit Colorado can ask for. One word covered a debt somebody owed and a fact about the calendar. So provisionality is now **per figure** rather than per state-year: each one names the path, whether it is `awaiting-publication` or `determined-after-year-end`, and the document that would settle it. **Michigan is why it has to be per figure** — its personal exemption is published for 2026 and its special exemption for a blind or disabled filer is not, because the first is a withholding allowance and the second appears only on the MI-1040, and one enum on the state-year cannot say that. Ohio was the same shape in reverse: its `$26,050` zero band was flagged and is statutory (HB 96 wrote it into § 5747.02(A)(3)), and only the exemption chart is really carried. [`test/provisional.test.js`](packages/us-state-tax/test/provisional.test.js) keeps the ledger honest — every path must resolve, `resolvedBy` must name a document rather than a government, and **a figure marked as carried forward from 2025 must still equal the 2025 value**, so a figure cannot be quietly resolved while the warning about it stays up. California is deliberately left flagged: several sources report a "2026" California standard deduction that is this package's 2025 figure while giving an exemption credit that is not, and a source that indexes one and not the other has stitched a fresh number onto a stale one. **And v0.28.0 gives a separate return the spouse it does not contain.** IRC § 151(b) allows a filer who files separately an exemption for a spouse with no gross income who is nobody else's dependent — the one sentence in the Code that reaches a separate return and NOT a joint one, because on a joint return both spouses are already the taxpayer — and four states here reach the same result by two different routes: **Virginia** (§ 58.1-322.03(1), `$930` for each personal exemption allowable FEDERALLY, plus its `$800` aged exemption, which § 58.1-322.03(2)(b) gives to "each blind or aged taxpayer as defined under § 63(f)") and **Illinois** (35 ILCS 5/204(b), `$2,850`) by pointing at the federal provision; **Maryland** (Tax-Gen. § 10-211, `$3,200` and stepped by federal AGI like every other Maryland exemption) and **Indiana** (IC 6-3-1-3.5(a), `$1,000`) by copying § 151(b)'s own sentence into their statutes. **New Jersey expressly does not** — N.J.S.A. 54A:3-1(b) conditions the spouse's exemption on a joint return and attaches the identical "files no New Jersey return" condition to a DOMESTIC PARTNER instead — so the shape of the federal rule is present in a state's law and points at a different person, and an engine that generalised from the other four would be confidently wrong in the direction nobody complains about. Every state with an exemption now DECLARES its answer with its own citation, no two `claimed` states may share one, and four — Massachusetts, Michigan, Mississippi and Ohio — say plainly that **nobody has read the provision** rather than that the state said no, naming the statute and what it would be worth. Whether Maryland's, Indiana's and Illinois's `$1,000` additions at 65 follow that spouse is a SEPARATE claim and is open; the result says so to any caller who supplied a `spouseAge` it then discarded. | |
...
| [`tools/differential`](tools/differential) | **703 households through both this project's engines and [PolicyEngine-US](https://github.com/PolicyEngine/policyengine-us)**, every figure compared to the dollar. Twenty-two days used PolicyEngine as a *parameter* reference — read the YAML, check a number. This runs it as a *model*, which is where the interesting errors live: not what a figure is, but what a computation does with it. Its first run found ten states taxing Social Security that exempt it by statute, a $17,159 difference in federal taxable income that turned out to be a real property of the harness rather than of either engine, and a metric mismatch in the harness itself. **As of v0.21.0 there are ZERO unexplained differences**, and getting there needed a new kind of bound: a reason about a RATE cannot state its size in dollars, because one 0.17-point county rate disagreement is $43.76 on a $30,000 household and $678.70 on a $400,000 one, and a `maxAbs` wide enough for the second would silently explain any Maryland defect under $700. So an entry may now bound itself by a SHARE OF INCOME as well as by a dollar figure. Every remaining difference is matched by a reason in `known-divergences.json`, every reason states the size it claims, and a reason that has stopped matching anything is printed too. **Zero unexplained is not the same as the two engines agreeing — it means the grid has stopped finding things**, so Day 26 added ten household shapes and the grid went from 437 cases to 646. It came back with 61 unexplained differences and five real defects behind them: a QUALIFYING SURVIVING SPOUSE taking the joint earned income credit threshold federally, which moved the state answer in six more states; the same status taking a second personal exemption in three states and the joint standard deduction in Virginia, which has no such status; three states' aged and blind allowances that no case had ever been able to reach; and a fault in the harness itself, where `taxable_pension_income` is a SUM of two PolicyEngine variables and New York's pension exclusion reads the parts, so six New York households had been answered by a model that could not see the pension. That last one surfaced as a $1,120 disagreement that had not existed the day before, and the cause was an upgrade of the reference model — which is why `theirs.py` now records the PolicyEngine version and the SHA-256 of the exact grid it answered, and `compare.mjs` refuses to write a report when the fingerprint does not match. **Day 27 added three shapes and learned the sharper version of the same lesson.** Day 26's surviving spouse earns `$45,000`, and the § 24 threshold she turned out to be wrong about does not bite until `$200,000` — so ADDING A FILING STATUS TO A GRID TESTS IT ONLY AT THE INCOMES THE GRID ALREADY HAD. She now files at `$250,000`, `$300,000` and `$450,000`: inside the phase-out band, past its end, and past the JOINT threshold too, which is the case that separates "this package now uses `$200,000`" from "this package lost the credit for some other reason", and it is the case where the two engines agree. It found one more defect here — Illinois disallows its exemption allowance above `$250,000` for "all other returns" and `byStatus()` had defaulted a widow to the joint `$500,000` — and it made this project's **largest explained entry a place where the reference model is wrong**: 38 differences where PolicyEngine gives a widow the full `$2,200` child tax credit and the statute does not. And the harder lesson came from CI rather than from the grid: the three federal fixes of Day 27 were pushed against the OLD 646-case grid and the golden report came back **byte-identical**. § 199A is unreachable from this harness in principle — a case may contain only facts that map onto a PolicyEngine variable without interpretation, and a business is not one — and PolicyEngine carries the joint `$400,000` for § 24 as well, so even a case that reached the threshold would have agreed on the wrong answer. **A differential test is bounded by the vocabulary of its cases, and that bound is invisible from inside the report.** |
...
npm i https://github.com/LoganChu/Agent_Playground/releases/download/us-tax-mcp-v0.31.0/us-tax-mcp-0.31.0.tgz
```
...
against Michigan's own indexed $5,900 — $14.40 of tax a year at Detroit's rate. The
...
### v0.28.0: the spouse who is not on the return

A **separate return** is the one filing status whose answer depends on a person it does not
contain. IRC § 151(b) allows the filer an exemption for their spouse "if a separate return is
made by the taxpayer, and if the spouse ... has no gross income and is not the dependent of
another taxpayer" — the one sentence in the Code that gives a separate return something a
joint one does not, because on a joint return both spouses are already the taxpayer. This
package had no way to be told that fact, so it counted nobody in every state.

**Four states reach the same result and they reach it two different ways.** Virginia and
Illinois define their own exemption *by reference to § 151*; Maryland and Indiana copied
§ 151(b)'s sentence into their own statutes. **New Jersey expressly does not** — N.J.S.A.
54A:3-1(b) conditions the spouse exemption on a joint return and attaches the identical
"files no return" condition to a *domestic partner* instead. So this is not a federal rule a
state inherits, and it is now a per-state declaration with a per-state citation.
...
stateIncomeTax({ state: 'VA', ...separate }).exemptions;
// 1730   — $930 personal + $800 aged, for the filer alone

stateIncomeTax({ state: 'VA', ...separate,
                 spouseHasNoGrossIncomeAndIsNotADependent: true }).exemptions;
// 3460   — the spouse's $930 AND their $800, because § 58.1-322.03(2)(b) gives
//          the aged exemption to "each blind or aged taxpayer as defined under
//          § 63(f)", and § 63(f)(1)(B) reaches exactly this spouse
```

**The two halves are two claims, and only Virginia settles both.** A statute that says the
spouse is an exemption has not thereby said the spouse is an *aged* exemption. Maryland's,
Indiana's and Illinois's additions at 65 are written in their own words, nobody has read
whose spouse they reach, and the result **says so** rather than guessing:

```js
stateIncomeTax({ state: 'MD', ...separate,
                 spouseHasNoGrossIncomeAndIsNotADependent: true }).notes;
// [ 'Maryland counts the spouse for the base exemption on this return, but whether
//    its additional exemptions for age and blindness follow that spouse is a
//    SEPARATE question and it is open: ... So `spouseAge` ... was not counted here,
//    and this return may be too high.' ]
```

Four more states — Massachusetts, Michigan, Mississippi and Ohio — have an exemption and have
**not been read**. They count nobody, which is today's answer and the one that does not
flatter the filer, and a caller who supplies the fact is told it was discarded *and that the
reason is that nobody read the provision, not that the state said no*. Georgia and New York
are out of the question entirely because they give the filer no exemption at all, and the
test proves that against the table rather than taking the declaration's word for it.

Defaults to **false**: nothing else on a return implies it, and one dollar of the spouse's
gross income fails it outright. A separate return that leaves it out is told what it cost.
