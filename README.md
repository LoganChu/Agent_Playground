...
npm i https://github.com/LoganChu/Agent_Playground/releases/download/us-tax-mcp-v0.22.0/us-tax-mcp-0.22.0.tgz
```
...
```jsonc
{
  "mcpServers": {
    "us-tax": {
      ...
      "args": [
        "-y",
        "https://github.com/LoganChu/Agent_Playground/releases/download/us-tax-mcp-v0.22.0/us-tax-mcp-0.22.0.tgz"
      ]
    }
  }
}
