...
const NOTES: readonly string[] = [
  ...
  'Ohio does not tax Social Security or railroad retirement benefits at all, and deducts them on the Schedule of Adjustments — R.C. 5747.01(A)(5). The taxable part is subtracted here from `taxableSocialSecurity`. The retirement income credit that is also modelled is worth at most $200 and is gone above $100,000 of modified AGI less exemptions.',
