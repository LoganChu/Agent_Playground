...
const NOTES: readonly string[] = [
  ...
  'Not modelled: Ohio school district income tax, which about 200 of the 600-odd districts levy at 0.25% to 2.00% on a separate SD 100 return — on Ohio taxable income for a traditional district and on earned income only for an earned-income district. A resident of a taxing district owes it on top of everything computed here, and it can be worth more than the municipal tax in the rural districts that levy it.',
