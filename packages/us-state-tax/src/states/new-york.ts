...
const NOTES: readonly string[] = [
  ...
  'NOT MODELLED — New York City and Yonkers. A New York City resident pays a city income tax of roughly 3.08% to 3.88% on the same taxable income, and a Yonkers resident pays a surcharge of 16.75% of the state tax. A New York City resident computed here is short by most of a percentage point of AGI or more. Neither is a state tax and neither is in this result.',
